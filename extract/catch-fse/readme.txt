...
2. Type in Catch FSE in the search form and press the 'Enter' key on your keyboard.
3. Click on the 'Activate' button to use your new theme right away.
4. Go to https://catchthemes.com/themes/catch-fse/#theme-instructions/ for a guide on how to customize this theme.
...
* Added:
    - New template part and pattern added for header with cart support
    - New page template added for woo-commerce products support
* Bug Fixed: Removed double used wp:post-author and unnecessary wp-block-group in single page
...
* Bug Fixed: Removed double used  wp:post-author in single page
...
= 1.2 (Released: June 03, 2022) =
* Added: More colors added to color palette
* Added: Global styles, Dark and Light color scheme
* Bug Fixed: Color issue in header of templates
* Updated: Footer, header and other templates updated to manage colors for Global Styles
* Updated: CSS and patterns to fix small bugs
...
Catch FSE WordPress Theme, 2021-2023 Catchthemes.com
...
Illustrated by Mohamed Hassan. CC0.
Featured Post 1: https://pxhere.com/en/photo/1450373
Featured Post 2: https://pxhere.com/en/photo/1444653
Featured Post 3: https://pxhere.com/en/photo/1447083

Hero Content: https://pxhere.com/en/photo/1639701
