...
function catch_fse_admin_plugin_notice() {
	...
	if ( ! PAnD::catch_fse_is_admin_notice_active( 'notice-seven-7' ) ) {
		return;
	}
	...
	if ( ! class_exists( 'FSE_PRO' ) ) {
	    ...
	    ?>
	    <div data-dismissible="notice-seven-7" class="notice notice-info is-dismissible catch-fse-admin-notice">
